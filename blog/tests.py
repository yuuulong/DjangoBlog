...
class ArticleTest(TestCase):
    ...
    def test_validate_article(self):
        ...
        user = BlogUser.objects.get_or_create(email="yuuuulong@gmail.com", username="yuuuulong")[0]
        user.set_password("yuuuulong")
        user.is_staff = True
        ...
        self.client.login(username='yuuuulong', password='yuuuulong')
        rsp = self.client.get('/refresh')
        ...
        p = Paginator(Article.objects.filter(author__username='yuuuulong'), 2)
        self.__check_pagination__(p, '作者文章归档', 'yuuuulong')
        ...
        u = gravatar_url('yuuuulong@gmail.com')
        u = gravatar('yuuuulong@gmail.com')
    ...
    def test_validate_feed(self):
        user = BlogUser.objects.get_or_create(email="yuuuulong2@gmail.com", username="yuuuulong")[0]
        user.set_password("yuuuulong")
        user.save()
        self.client.login(username='yuuuulong', password='yuuuulong')
