...
class AccountTest(TestCase):
    ...
    def test_validate_account(self):
        ...
        user = BlogUser.objects.create_superuser(email="yuuuulong@gmail.com",
                                                 username="yuuulong", password="qwer!@#$ggg")
        testuser = BlogUser.objects.get(username='yuuulong')

        loginresult = self.client.login(username='yuuulong', password='qwer!@#$ggg')
