...
# SECRET_KEY = 'g)&=b7=&me5gd@sl2-*!n5enb_0290xvryxx5yrm8e17ozi-#l'
...
STATIC_ROOT = os.path.join(SITE_ROOT, 'collectedstatic')  # 服务器收集静态文件
...
LOGGING = {
    ...
    'handlers': {
        'log_file': {
            ...
            'filename': 'djangoblog.log',  # 在服务器目录下建同名文件夹
